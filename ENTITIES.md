...
```
oopDesc {
  volatile markWord _mark;           // Mark word (8 bytes on 64-bit): lock state, GC info, identity hash
  union _metadata {
    Klass*      _klass;              // Uncompressed klass pointer (8 bytes)
    narrowKlass _compressed_klass;   // Compressed klass pointer (4 bytes) if UseCompressedClassPointers
  } _metadata;
  // Object fields follow...
}
```
- Source: [`src/hotspot/share/oops/oop.hpp#L43-L52`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/oop.hpp#L43-L52)
...
```
- Source: [`src/hotspot/share/oops/method.hpp#L68-L85`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/method.hpp#L68-L85)
...
```
- Source: [`src/hotspot/share/oops/constMethod.hpp#L25-L80`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/constMethod.hpp#L25-L80)
...
```
- Source: [`src/hotspot/share/oops/methodCounters.hpp`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/methodCounters.hpp)
...
- Source: [`src/hotspot/share/oops/constantPool.hpp#L118-L145`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/constantPool.hpp#L118-L145)
...
- Source: [`src/hotspot/share/oops/annotations.hpp`](https://github.com/openjdk/jdk/blob/master/src/hotspot/share/oops/annotations.hpp)
